...
//            Car car = new Car(new Color(rand.nextFloat(), rand.nextFloat(), rand.nextFloat()), p.x, p.y, 30, 30, 15, index);
            Car car = new Car(Color.CYAN, p.x, p.y, 30, 30, /*rand.nextInt(5) + 10*/ 15, index);
            road.addCar(car);
